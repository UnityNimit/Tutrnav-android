package com.onrender.tutrnav.adapters;
...
public class StudentDiscoverAdapter extends RecyclerView.Adapter<StudentDiscoverAdapter.DiscoverViewHolder> {
    ...
    public StudentDiscoverAdapter(List<TuitionModel> list, OnTuitionClickListener listener) {
        this.list = list;
    ...
    public DiscoverViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_student_discover_class, parent, false);

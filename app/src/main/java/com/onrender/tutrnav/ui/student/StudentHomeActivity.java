...
public class StudentHomeActivity extends AppCompatActivity {
    ...
    private static class ViewPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                case 0: return new StudentDiscoverFragment();
                case 1: return new StudentScheduleFragment();
                case 2: return new StudentMapsFragment();
                case 3: return new StudentNotificationsFragment();
                default: return new StudentDiscoverFragment();
            }
        }
